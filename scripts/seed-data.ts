...
const destinations = [
  {
    ...
    description: "A breathtaking valley surrounded by snow-capped peaks, ancient forts, and turquoise lakes. Known as the jewel of the Karakoram.",
    price: 65000,
    originalPrice: 85000,
    ...
    included: ["Hotel Accommodation", "All Meals", "Transport", "Guide", "Activities"],
    itinerary: [
  ...
  },
  {
    ...
    name: "Skardu",
    region: "Gilgit-Baltistan",
    description: "Home to the world's highest peaks and deepest lakes. A paradise for mountaineers and nature lovers alike.",
    price: 72000,
    originalPrice: 95000,
    ...
    included: ["Hotel Accommodation", "All Meals", "Transport", "Guide", "Boat Ride"],
    itinerary: [
  ...
  },
  {
    ...
    name: "Fairy Meadows",
    region: "Gilgit-Baltistan",
    description: "A lush green meadow at the base of Nanga Parbat, the 9th highest mountain in the world. An unforgettable trek.",
    price: 58000,
    originalPrice: 75000,
    ...
    included: ["Camping Stay", "Meals", "Jeep Transfer", "Guide", "Trekking Gear"],
    itinerary: [
  ...
  },
  {
    ...
    description: "Valley of lakes and meadows nestled in the Himalayas. Shogran, Siri Paye, and Lake Saiful Muluk await you.",
    price: 45000,
    originalPrice: 60000,
    duration: "4 Days / 3 Nights",
    rating: 4.7,
    ...
    included: ["Hotel Accommodation", "Meals", "Transport", "Guide", "Boat Ride"],
    itinerary: [
  ...
  },
  {
    ...
    name: "Swat Valley",
    region: "Khyber Pakhtunkhwa",
    description: "The Switzerland of the East. Crystal-clear rivers, alpine forests, and Buddhist heritage sites create a magical blend.",
    price: 42000,
    originalPrice: 55000,
    ...
    included: ["Hotel Accommodation", "Meals", "Transport", "Guide"],
    itinerary: [
  ...
  },
  {
    ...
    name: "Gilgit",
    region: "Gilgit-Baltistan",
    description: "The gateway to the Karakoram Highway. Ancient silk route history meets stunning mountain landscapes.",
    price: 62000,
    originalPrice: 80000,
    duration: "5 Days / 4 Nights",
    rating: 4.7,
    ...
    included: ["Hotel Accommodation", "All Meals", "Transport", "Guide", "Karakoram Highway Tour"],
    itinerary: [
  ...
  },
  {
    ...
    name: "Neelum Valley",
    region: "Azad Kashmir",
    description: "The blue gem of Kashmir. Lush green hills, cascading waterfalls, and pristine rivers as far as the eye can see.",
    price: 48000,
    originalPrice: 62000,
    duration: "4 Days / 3 Nights",
    rating: 4.7,
    ...
    included: ["Hotel Accommodation", "Meals", "Transport", "Guide", "Sightseeing"],
    itinerary: [
  ...
  },
  {
    ...
    name: "Deosai Plains",
    region: "Gilgit-Baltistan",
    description: "The Land of Giants — the second-highest plateau in the world. Wildflowers, marmots, and endless skies.",
    price: 78000,
...
const reels = [
  { id: "hunza-reel", destination: "Hunza Valley", description: "Where mountains touch the sky and time stands still.", video: "/videos/video-1.mp4" },
  { id: "skardu-reel", destination: "Skardu", description: "Turquoise waters of Shangrila, heaven on Earth.", video: "/videos/video-2.mp4" },
  { id: "fairy-reel", destination: "Fairy Meadows", description: "Sleep beneath the mighty Nanga Parbat.", video: "/videos/video-3.mp4" },
  { id: "naran-reel", destination: "Naran Kaghan", description: "Lake Saiful Muluk — the lake of fairy tales.", video: "/videos/video-4.mp4" },
  { id: "swat-reel", destination: "Swat Valley", description: "The Switzerland of the East awaits you.", video: "/videos/video-5.mp4" },
  { id: "gilgit-reel", destination: "Gilgit", description: "Ancient silk route, modern adventures.", video: "/videos/video-6.mp4" },
  { id: "khunjerab-reel", destination: "Khunjerab Pass", description: "Where China meets Pakistan at 4,693 meters.", video: "/videos/video-7.mp4" },
];
...
const galleryImages = [
  { src: "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&q=80", alt: "Hunza Valley panorama", category: "Mountains" },
  { src: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&q=80", alt: "Lake reflection at sunrise", category: "Lakes" },
  { src: "https://images.unsplash.com/photo-1512100356356-de1b84283e18?w=800&q=80", alt: "Mountain campsite", category: "Adventure" },
  { src: "https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?w=800&q=80", alt: "Misty mountain valley", category: "Nature" },
  { src: "https://images.unsplash.com/photo-1528164344705-47542687000d?w=800&q=80", alt: "Northern landscape", category: "Mountains" },
  { src: "https://images.unsplash.com/photo-1504893524553-b855bce32c67?w=800&q=80", alt: "Turquoise river", category: "Lakes" },
];
...
async function seed() {
  ...
  for (const col of collections) {
    ...
    if (existing > 0) {
      console.log(`${col.name}: already has ${existing} documents, skipping.`);
      continue;
    }

    const docs = col.data.map((item) => ({
      ...item,
      createdAt: now,
      updatedAt: now,
    }));

    const result = await db.collection(col.name).insertMany(docs);
