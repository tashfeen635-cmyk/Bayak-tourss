              ...
              <div className="relative z-10">
                ...
                <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
                  <a
                    ...
                    className="inline-flex items-center justify-center gap-2 rounded-full bg-white px-6 py-3 text-base font-semibold text-gold hover:bg-white/90 sm:px-8"
                  >
                  ...
                  <Link
                    href="/contact"
                    className="inline-flex items-center justify-center rounded-full bg-charcoal px-6 py-3 text-base font-semibold text-white hover:bg-charcoal/90 sm:px-8"
                  >
                    Contact Us
                  </Link>
                </div>
