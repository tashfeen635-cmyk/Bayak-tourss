    ...
    <>
      <section className="relative flex min-h-[50vh] items-center justify-center overflow-hidden bg-charcoal pt-20 pb-12 sm:pt-32 sm:pb-20">
        ...
        <div className="relative z-10 px-4 text-center">
          <FadeIn>
            <h1 className="font-heading text-[38px] font-bold text-white sm:text-5xl md:text-6xl">
              Tourist Visa
            </h1>
      ...
      <section className="py-12 sm:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <StaggerContainer className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <StaggerItem>
              <div className="h-full rounded-2xl border border-dashed border-gold/40 bg-gold/5 p-5 sm:p-8">
            ...
            <div className="relative overflow-hidden rounded-3xl bg-gold px-5 py-10 text-center sm:px-8 sm:py-16 md:px-16">
              ...
              <div className="relative z-10">
                ...
                <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
                  <Link
                    href="/contact"
                    className="inline-flex items-center justify-center rounded-full bg-white px-6 py-3 text-base font-semibold text-gold hover:bg-white/90 sm:px-8"
                  >
                    Contact Us
                  </Link>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center gap-2 rounded-full bg-charcoal px-6 py-3 text-base font-semibold text-white hover:bg-charcoal/90 sm:px-8"
                  >
